      ...
      return view("page", [
        ...
        "departments" => [
          ...
          "sesame-oil-vermicelli" => [
            "name" => "麻油麵線",
            "intro" => "麵線的與麻油的搭配也堪稱一絕，它是迎接冬天最好的料理之一！既可暖身又能提神，麵線裡的米酒襯托出麻油的香味，令人垂延三尺。台灣大多會與雞肉搭配，變成「麻油雞麵線」，當然加了雞之後不熱量大增，價錢也跟著提高不少，如果只是單純想吃口感，可以只點麻油雞就好囉！",
            "ability" => [
              "濃厚指數" => "☺",
              "鮮味指數" => "☺☺☺",
              "香氣指數" => "☺☺☺☺☺"
    ...
    public function oysters()
    {
      return view("page", [
        ...
        "departments" => [
          ...
          "oyster-soup" => [
            "name" => "蚵仔湯",
            "intro" => "蚵仔調理的方法相當多元，不管是哪來煮、煎、炒、炸都有，甚至是拿來做湯料理。一般做湯會跟薑絲做為搭配，再加入米酒與香油，最後再放上一點蔥花搭配。蚵仔的湯汁與湯的完美結合，可以消除疲勞、增進體力與精力、抗壓解憂。做為現代人或不可缺的精力大補湯！壓力較大的工作者或有做人計劃的夫妻都很適合飲用！",
            "ability" => [
              "多汁指數" => "☺☺☺☺☺",
              "鮮味指數" => "☺☺☺☺",
              "工法指數" => "☺☺"
    ...
    public function thick_soup()
    {
      return view("page", [
        ...
        "departments" => [
          ...
          "squid-thick-soup" => [
            "name" => "魷魚羹",
            "intro" => "魷魚營養豐富，肉質鮮美，Q彈有勁，歷來為廣大消費者所喜愛。牠含有豐富的鈣、磷、鐵元素，對骨骼發育和造血十分有益，經常食用可預防貧血。與羹的結合對中老年人來說，不但健康，也方便食用。它也是台灣人的童年回憶，每當下課或下班時，總是要來一碗魷魚羹來解解嘴饞。",
            "ability" => [
              "工法指數" => "☺☺",
              "鮮味指數" => "☺☺☺☺",
              "豐富指數" => "☺☺☺☺☺"
          ...
          "calamary-thick-soup" => [
            "name" => "花枝羹",
            "intro" => "花枝羹（亦名為花枝焿或生炒花枝）是普及於台灣市集販售的海鮮食品，大眾化小吃，台北士林夜市尤為著名。常見的有花枝切塊，加勾芡形成稠湯，再加醃筍塊或筍絲、香菇絲、木耳、蝦米、豆芽、蛋花，加沙茶、九層塔、烏醋、醬油、芥末，即可。口感與肉羹較為相似，但又比肉羹有彈性。",
            "ability" => [
              "工法指數" => "☺☺☺☺",
              "鮮味指數" => "☺☺☺☺",
              "豐富指數" => "☺☺☺"
          ...
          "pork-thick-soup" => [
            "name" => "肉羹",
            "intro" => "臺灣傳統羹類料理具代表性的一種，是普及於臺灣市集販售的豬肉副食製品，食用歷史悠久，是十分大眾化的小吃。做法也相當多元，不過使用的食材原則上大同小異，大部份是先將瘦肉及肥肉剁成泥狀，拌入鹽、糖、白胡椒粉，香油，太白粉和油蔥酥，將肉泥攪拌至產生極強黏性後拌入魚漿。最後將肉泥捏成顆粒，投於沸湯內，煮熟撈起即可，料理上僅有火候及調味料上的差別。",
            "ability" => [
              "工法指數" => "☺☺☺☺☺",
              "鮮味指數" => "☺☺",
              "豐富指數" => "☺☺☺"
      ...
      return view("page", [
        ...
        "departments" => [
          "black-tapioca-pearls-curd" => [
            "name" => "粉圓豆花",
            "intro" => "融合豆花及粉圓這兩樣道地台灣甜點的粉圓豆花，受到台灣各年齡層的歡迎。在冬天時可以淋上熱呼呼的薑汁糖水，讓身子從裡暖到外。在炎熱夏日則可以加上一勺細緻的剉冰，享受沁人心脾的美味。不管哪種吃法都十分的清爽又可口，且其不含脂肪，在滿足饞嘴的同時也不會給身體帶來多餘負擔。",
            "ability" => [
              "甜蜜指數" => "☺☺☺",
              "豐富指數" => "☺☺☺☺",
              "方便指數" => "☺☺☺"
          ...
          "three-color-tapioca" => [
            "name" => "三色粉圓",
            "intro" => "由飲料店「丸作」獨創。一般飲料店較常見的有混合波霸及小珍珠的混珠，或是由白珍珠及黑珍珠混合的熊貓珍珠，丸作則是在白玉珍珠及焦糖黑珍珠以外，再加入紅珍珠，製作出美觀又可口的三色珍珠。且紅珍珠的顏色來自仙人掌果汁，完全不含色素，在享受美味的同時也兼顧健康。",
            "ability" => [
              "甜蜜指數" => "☺☺☺",
              "豐富指數" => "☺☺☺",
              "方便指數" => "☺☺☺☺☺"
